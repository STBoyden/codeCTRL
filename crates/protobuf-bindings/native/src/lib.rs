...
pub mod logs_service {
	...
	pub use log_server_server::{LogServer as LogServerTrait, LogServerServer as LogServerService};

	#[cfg(not(target_arch = "wasm32"))]
	pub use log_client_server::{LogClient as LogClientTrait, LogClientServer as LogClientService};
